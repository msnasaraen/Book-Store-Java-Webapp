...
function templateGetInventory(param) {
  ...
  '<li><span style="font-size: 13px ;color: #E6ECEA;">' + param.name + '</span></li>' +
  ...
  '</tr>' +
  '<tr id="row2">' +
  '<td ><div id="detail1"><span style="font-size: 13px ;color: #E6ECEA;">' + param.category + '</span></div></td>' +
  '<td id="detail2">' +
  '<ul style="list-style-type: none">' +
